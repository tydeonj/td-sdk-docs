...
> 文档版本：**1.1.6**  
> SDK 版本：Android **`1.1.2.8`** · iOS **`1.1.2.9`**
...
target 'YourApp' do
  pod 'TDAdsBase', '1.1.2.9'
  pod 'TDAdsSDK',  '1.1.2.9'
end
```
